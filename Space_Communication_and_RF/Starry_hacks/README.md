...
Click the **STATUS** button (or send `STATUS` via the Command Console). `main.py` calls `handle_command("STATUS")`, the backdoor runs, and the output is returned to the console.
