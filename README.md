...
- 🌐**GitHub Pages**
  ...
  [https://jonghomoon.github.io/STARPWN-2026-Writeup/](https://jonghomoon.github.io/STARPWN-2026-Writeup/)
...
| # | Challenge | Points | Solves | Flag |
|---|-----------|--------|--------|------|
| 1 | [Rogue Ground Station](./Physical/Rogue_Ground_Station/) | 500 | 2 | `flag(CAFE0000,4E620000}`<br>`flag(CAFE0000,03B90000}`<br>`flag(CAFE0000,25FD0000}`<br>`flag(CAFE0000,3E480000}`<br>`flag(CAFE0000,E2960000}`<br>`flag(CAFE0000,E78E0000}`<br>`flag(CAFE0000,DF400000}`<br>`flag(CAFE0000,0F550000}` |
...
| # | Challenge | Points | Solves | Flag |
|---|-----------|--------|--------|------|
| 1 | [Orbital Integrity](./Space_Operations/Orbital_Integrity/) | 421 | 224 | `STARPWN{2911565936}` |
| 2 | [Time to Intercept](./Space_Operations/Time_to_Intercept/) | 473 | 132 | `STARPWN{h0hm4nn_tr4nsf3r_1nt3rc3pt}` |
| 3 | [Time to Intercept -V2](./Space_Operations/Time_to_Intercept_V2/) | 494 | 65 | `STARPWN{dont_print_th3_answer_}` |
| 4 | [Tumbling Through Space](./Space_Operations/Tumbling_Through_Space/) | 471 | 137 | `STARPWN{d3tumbl3_m4st3r_sp4c3_0p5}` |
